...
var boxClickEvent = document.createEvent('Event');
boxClickEvent.initEvent('boxClickEvent',true,true);

jsPsych.plugins['instructions-mousetracking'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-mousetracking',
    description: '',
    parameters: {
      pages: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    buttonboxstyle += '</style>';
      ...
      display_element.innerHTML += buttonboxstyle;
      ...
      display_element.innerHTML += '<div class="jspsych-survey-mousebox" id="mouseboxsubmitbttn" onclick=\'document.querySelector("#mouseboxsubmitbttn").dispatchEvent(boxClickEvent);\'></div>';
      
      display_element.querySelector('#mouseboxsubmitbttn').addEventListener('boxClickEvent', function(e){
